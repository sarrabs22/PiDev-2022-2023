 ...
 */
final class Version20230216181203 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE evenement CHANGE materiel materiel VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE evenement CHANGE materiel materiel VARCHAR(255) DEFAULT NULL');
    }
}
