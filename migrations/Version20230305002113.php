 ...
 */
final class Version20230305002113 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE membre CHANGE experience experience VARCHAR(10000) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE membre CHANGE experience experience VARCHAR(10000) DEFAULT NULL');
    }
}
